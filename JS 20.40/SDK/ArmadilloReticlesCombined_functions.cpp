...
// struct FGameplayTag                     NewCursorModeTag                                       (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, NoDestructor, HasGetValueTypeHash)
// struct FGameplayTag                     OldCursorModeTag                                       (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, NoDestructor, HasGetValueTypeHash)
...
void UArmadilloReticlesCombined_C::ExecuteUbergraph_ArmadilloReticlesCombined(int32 EntryPoint)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ExecuteUbergraph_ArmadilloReticlesCombined");
...
void UArmadilloReticlesCombined_C::GetIndexForWeaponClass(class AFortWeapon* InFortWeapon, int32* OutIndex)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("GetIndexForWeaponClass");
...
void UArmadilloReticlesCombined_C::InitializeWeaponOverheatDisplay(class AFortWeaponRanged* InWeapon)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("InitializeWeaponOverheatDisplay");
...
void UArmadilloReticlesCombined_C::OnChainStoppedFiring()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnChainStoppedFiring");
...
void UArmadilloReticlesCombined_C::OnNewWeaponActivated()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnNewWeaponActivated");
...
void UArmadilloReticlesCombined_C::OverheatChange(float CurrentValue, float MaxValue, EFortWeaponOverheatState State, bool bIsInCooldown)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OverheatChange");
...
void UArmadilloReticlesCombined_C::UpdateWeaponIconInViewportMesh(class AFortWeaponRanged* InWeapon)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("UpdateWeaponIconInViewportMesh");
