...
void ABP_AudioVis_C::ExecuteUbergraph_BP_AudioVis(int32 EntryPoint)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ExecuteUbergraph_BP_AudioVis");
...
void ABP_AudioVis_C::LogAmplitudeValues()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("LogAmplitudeValues");
...
void ABP_AudioVis_C::LogoRotation(float DeltaSeconds)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("LogoRotation");
...
void ABP_AudioVis_C::ToggleAudioVisualizer(bool IsVoPlaying_0)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ToggleAudioVisualizer");
...
void ABP_AudioVis_C::ToggleLogoMesh(bool IsVoPlaying_0)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ToggleLogoMesh");
...
void ABP_AudioVis_C::ToggleVisualizerMeshes(bool IsVoPlaying_0)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ToggleVisualizerMeshes");
...
void ABP_AudioVis_C::VisualizerVisibilityTimeline__FinishedFunc()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("VisualizerVisibilityTimeline__FinishedFunc");
...
void ABP_AudioVis_C::VisualizerVisibilityTimeline__UpdateFunc()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("VisualizerVisibilityTimeline__UpdateFunc");
