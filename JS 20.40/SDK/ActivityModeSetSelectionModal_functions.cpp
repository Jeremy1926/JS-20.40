...
void UActivityModeSetSelectionModal_C::BndEvt__ActivityModeSetSelectionModal_ModeSetSelection_K2Node_ComponentBoundEvent_2_OnListItemSelectionChangedDynamic__DelegateSignature(class UObject* Item, bool bIsSelected)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("BndEvt__ActivityModeSetSelectionModal_ModeSetSelection_K2Node_ComponentBoundEvent_2_OnListItemSelectionChangedDynamic__DelegateSignature");
...
void UActivityModeSetSelectionModal_C::BndEvt__ActivityModeSetSelectionModal_ModeSetSelection_K2Node_ComponentBoundEvent_3_SimpleListItemEventDynamic__DelegateSignature(class UObject* Item)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("BndEvt__ActivityModeSetSelectionModal_ModeSetSelection_K2Node_ComponentBoundEvent_3_SimpleListItemEventDynamic__DelegateSignature");
...
void UActivityModeSetSelectionModal_C::BndEvt__ActivityMultiModeModal_Button_BackBoard_K2Node_ComponentBoundEvent_0_CommonButtonClicked__DelegateSignature(class UCommonButtonLegacy* Button)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("BndEvt__ActivityMultiModeModal_Button_BackBoard_K2Node_ComponentBoundEvent_0_CommonButtonClicked__DelegateSignature");
...
// Parameters:
// class UFortGameActivity*                GameActivity                                           (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class FString                           StartingSelectedMnemonic                               (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, HasGetValueTypeHash)
...
void UActivityModeSetSelectionModal_C::SaveSelection()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("SaveSelection");
