...
// struct FGameplayTag                     CursorModeTag                                          (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, NoDestructor, HasGetValueTypeHash)
// bool                                    bShouldBeVisible                                       (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// Parameters:
// class AFortWeaponRanged*                Object                                                 (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void UArmadilloReticleBPBase_C::CheckIfAssault(const class AFortWeaponRanged* Object, bool* isAR)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("CheckIfAssault");
...
void UArmadilloReticleBPBase_C::ExecuteUbergraph_ArmadilloReticleBPBase(int32 EntryPoint)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ExecuteUbergraph_ArmadilloReticleBPBase");
...
void UArmadilloReticleBPBase_C::InitializeForRangedWeapon(class AFortWeaponRanged* InRangedWeapon)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("InitializeForRangedWeapon");
...
void UArmadilloReticleBPBase_C::OnLocalReloadCancelled()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnLocalReloadCancelled");
...
void UArmadilloReticleBPBase_C::OnLocalReloadStarted(float ReloadTime, EFortWeaponReloadType ReloadType)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnLocalReloadStarted");
...
void UArmadilloReticleBPBase_C::OnWeaponFireVisuals(class AFortWeapon* Weapon)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnWeaponFireVisuals");
...
void UArmadilloReticleBPBase_C::UpdateLocalPlayerStyling()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("UpdateLocalPlayerStyling");
