...
namespace Lategame
{
    ...
    FItemAndCount GetSnipers()
    {
        static UEAllocatedVector<FItemAndCount> Heals
        {
            ...
            //FItemAndCount(1, {}, FindObject<UFortWeaponRangedItemDefinition>(L"/FlipperGameplay/Items/Weapons/CoreSMG/WID_SMG_CoreSMG_Athena_UR_IOBrute.WID_SMG_CoreSMG_Athena_UR_IOBrute")), // stinger
